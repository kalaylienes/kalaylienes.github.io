...
{{< project-figure
    src="iarvr/introduction-motivation/iarvr-introduction-02-gameplay-shot.png"
    alt="Gameplay view showing the player guiding the carrot in front of the horse."
    caption="The player indirectly controls movement by guiding the carrot in front of the horse."
>}}
